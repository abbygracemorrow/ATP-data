...
* **Global filters** (Year, Tournament, and Additional Filters for Tier/Surface/Court/Round/Best of) apply to every other section on the page. **Reset all filters** clears everything, including the win/loss player, the leaderboard settings, and the head-to-head players.
